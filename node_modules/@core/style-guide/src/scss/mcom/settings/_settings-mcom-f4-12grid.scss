...
/**
  ...
  * @markup
      <div class="sample_csg_grid_demo">
        <div class="row">
          <div class="small-12 small-centered columns"> <-----     This is a 12-column grid row     ----> </div>
        ...
        <div class="row">
          <div class="small-2 columns">small-2</div>
          <div class="small-8 columns">small-8</div>
          <div class="small-2 columns">small-2</div>
        </div>
        <div class="row">
          <br/>
          ...
          <div class="small-12 medium-2 columns">small-12 medium-2</div>
          <div class="small-12 medium-8 columns">small-12 medium-8</div>
          <div class="small-12 medium-2 columns">small-12 medium-2</div>
        </div>
        <div class="row">
          <div class="small-2 large-6 columns">small-2 large-6</div>
          <div class="small-10 large-6 columns">small-10 large-6</div>
        </div>
        <div class="row">
          <br/>
...
$macysWarning-background: $macysWarningSecondary;    //
// DO NOT use                                        //
///////////////////////////////////////////////////////
