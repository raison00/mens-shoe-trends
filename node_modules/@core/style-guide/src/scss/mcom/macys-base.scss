// Global mcom settings and style overrides   
// This file is FOUNDATION 6 VERSION of CSG, to use Foundation 4 versions, please use other file designation
//
//////////////////////////////////////////////////////////////
// -- ONLY CSG team members should modify this file     //////
//////////////////////////////////////////////////////////////
//
// We use normalize for our css resets (lives in vendor folder)
...
// Additional global variables from Foundation  (includes normalize)
@import "components/global";  // *always required for use with Foundation

// from Foundation 4 Macys-Base.css
...
// macys-base.css components
// @import "~@core/vendor/scss/foundation-6.4.4-rc1/scss/grid/grid";        // for flex-grid
@import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/xy-grid/xy-grid';     // for xy-grid
@import 'components/typography';
// @import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/forms/forms';
@import 'components/forms';
// @import "components/notifications";
...
@import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/components/button-group';
// @import "components/split-buttons";
// @import "components/loader";


// @import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/components/accordion-menu';
// @import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/components/accordion';
...
@import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/components/flex';     // for vanilla flex-box, required for flex-grid
...
// @import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/components/switch';
...
// from Foundation 4 Macys-Base.css
// @import "./components/accessibility";
// @import "./components/grid-5";
// @import "~@core/vendor/scss/foundation-4.3.2/components/visibility";
...
// sprites generated by dr-svg-sprites
//@import "mcom-sprites"
...
@include foundation-flex-classes; // global flex class enabled for button-group, card, media-object, menu, title_bar, top_bar, & input_group
// @include foundation-prototype-classes;  // not used



// IF YOU NEED TO USE FLEX-GRID or FLOAT-GRID (BOTH Deprecated, btw), 
// Add the following to your project's scss files
// @import "~foundation-6.4.4-rc1/scss/grid/grid";     // for either float-grid or flex-grid
// @import '~foundation-6.4.4-rc1/scss/components/flex';  
// @include foundation-flex-classes;
// @include foundation-flex-grid;   // for flex-grid
