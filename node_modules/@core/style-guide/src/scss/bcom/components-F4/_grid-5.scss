...
//* ------------------------
//> Description:
//> This file is a copy of `macysCSS/src/common/base/foundation-4/components/_grid-5.scss` for BCOM
//> and has some adjustments for .row class in order to not break the layout because of .collapse class
//======================== */
...
@if $include-html-grid-classes != false {
  ...
  .row {
    ...
    &:before, &:after {
      content: none; //Fix display on Safari browser
    }
