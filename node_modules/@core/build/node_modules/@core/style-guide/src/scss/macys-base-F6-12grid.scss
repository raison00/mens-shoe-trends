...
@import "settings/settings-f6-12";
...
@import "./components-f6/global";  // *always required for use with Foundation
...
@import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/typography/typography';
...
@import '~@core/vendor/scss/foundation-6.4.4-rc1/scss/components/flex';     // for flex-grid
