...
//csg button fonts
$csg_v1_font-size-tiny: 0.75rem;
$csg_v1_font-size-small: 0.875rem;
$csg_v1_font-size-medium: 1rem;   //16px
$csg_v1_font-size-large: 1.250rem;
...
//  <li class="swatch"><div class="macysError"><div><p>macysError</p><p>#e91c2c</p></div></li>
//  <li class="swatch"><div class="macysWarning"><div><p>macysWarning</p><p>#f29a1c</p></div></div></li>
...
$macysWarning-background: #fffbdd;
//
// ==================================================================================================
// ==================================================================================================
...
$tertiary-color-active: $macysBlack; //#000;
...
$assets_host: '//assets.macysassets.com/navapp';
