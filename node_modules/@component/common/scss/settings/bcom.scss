...
//>
//> Create Date: <January 09, 2014>
//* ------------------------
//> Description:
//> This file is a copy of `macysCSS/src/common/base/foundation-4/_variables.scss` for BCOM
//> and it's meant to be used as a base for variables
//>
//> YOU SHOULD NOT ADD VARIABLES TO THIS FILE NOR EDIT THE ONES HERE
//> USE `macysCSS/src/bcom/base/_variables.scss` INSTEAD FOR OVERRIDES
//======================== */
...
// Conversion function to get pixel values (IE8 compatible values against rem units)
...
//BCOM: modified to return original px if IE8 flag is on, also modified to take multiple values
...
// READ ME
//======================== */
//> If you arrived here to add variables, you are doing it wrong!
//> Go back and read file's description for the correct place to include variables.
