...
//Secondary
$secondary-button-pip-color:$macysWhite;
$secondary-span-border-color:$macysWhite;
$include-html-splitButton-classes: $include-html-classes !default;


//2. Then import the Foundation file you're updating --
@import "../../foundation-4.3.2/components/split-buttons";
...
@if $include-html-button-classes !=false {
    ...
    button.split, .split.button {
        ...
        &.secondary {
            @include split-button(false, $split-button-pip-color, $secondary-span-border-color, false);
        }
        &.tertiary {
