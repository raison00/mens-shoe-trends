...
$legend-font-family: "Avenir LT W01 85 Heavy", Helvetica, Arial, sans-serif;
...
$input-warning-message-font-color: #fff !default;
$input-warning-message-font-color-alt: #333 !default;
...
select{
    background:url("/images/dropdown_active.png") $form-select-background-color 100%  center no-repeat;
}
.svg select{
    background:url("/images/dropdown_active.svg") 100% center no-repeat;
}
...
/**
  * @name Standard Form - Inline Input Fields
  * @section Forms
...
/**
  ...
  * </div>
  * <div class="large-8 columns">&nbsp</div>
  * </div>
  * </form>
  */
...
/**
  ...
  * <form class="standard-form">
  * <div class="row">
  * <div class="large-1 columns">&nbsp</div>
