...
// ##DESCRIPTION: A module that provides some utilities for doing more things with arrays
{
  ...
  function find(list, searchString, startsWith, contains, endsWith) {
    ...
    let j = -1;
    let found = false;
    const sw = typeof startsWith === 'undefined' ? false : startsWith;
    const ctns = typeof contains === 'undefined' ? false : contains;
    const ew = typeof endsWith === 'undefined' ? false : endsWith;
