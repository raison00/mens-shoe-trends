...
//
// ##DESCRIPTION: This mixin should be extended by any object that wants to be able to fire out methods
// with exact same name as *message.event* from pub/sub.
{
  const PubSubSubscriberMixin = {
    // ###Method - run
  ...
  module.exports = PubSubSubscriberMixin;
}
