...
// set up to receive and respond to http GET requests.
{
  ...
  const pixelHost = typeof globals.getValue('pixelHost') !== 'undefined' ? globals.getValue('pixelHost') : '//assets.macys.com';
  const pathToPixel = '/navapp/img/spacer.gif';
  ...
  function track(querystring, options) {
    ...
    if (typeof options === 'object') {
      ...
      if (options.append && ((typeof options.append === 'string' && options.append.toLowerCase() === 'true') || options.append === true)) {
        append = true;
      }
    }
    const i = $('<img/>', {
