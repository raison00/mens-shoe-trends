module.exports = {
  ...
  lastName: {
    required: 'This is required',
    alphaNumeric:
      'Alphanumeric only: this is a really really really really really really really really really really really really long message to test the line height spacing for multi-line error message display',
    minLength: 'Min length is 2',
    maxLength: 'Max length is 20',
  },
  address: {
